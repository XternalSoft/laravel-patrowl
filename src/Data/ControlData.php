...
final class ControlData
{
    /**
     * @param  array<int, string>  $cveIdentifiers
     * @param  array<int, string>  $references
     * @param  array<int, string>  $products
     * @param  array<int, ControlAssetData>  $assetsImpacted
     * @param  array<int, ControlAssetData>  $assetsWarning
     * @param  array<int, ControlVulnerabilityData>  $vulnerabilities
     */
    public function __construct(
        ...
        public array $assetsImpacted = [],
        public array $assetsWarning = [],
    ...
    public static function fromApi(array $data): self
    {
        ...
        return new self(
            ...
            assetsImpacted: isset($data['assets_impacted']) ? array_map(fn (array $item) => ControlAssetData::fromApi($item), (array) $data['assets_impacted']) : [],
            assetsWarning: isset($data['assets_warning']) ? array_map(fn (array $item) => ControlAssetData::fromApi($item), (array) $data['assets_warning']) : [],
            vulnerabilities: isset($data['vulnerabilities']) ? array_map(fn (array $item) => ControlVulnerabilityData::fromApi($item), (array) $data['vulnerabilities']) : [],
    ...
    public function toArray(): array
    {
        return [
            ...
            'assets_impacted' => array_map(fn (ControlAssetData $item) => $item->toArray(), $this->assetsImpacted),
            'assets_warning' => array_map(fn (ControlAssetData $item) => $item->toArray(), $this->assetsWarning),
            'vulnerabilities' => array_map(fn (ControlVulnerabilityData $item) => $item->toArray(), $this->vulnerabilities),
