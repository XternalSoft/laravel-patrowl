...
final class GetProductsRequest extends Request implements MapPaginatedResponseItems, Paginatable
{
    ...
    {
        return array_map(fn (array $item) => ProductData::fromApi($item), $response->json('results', []));
    }
